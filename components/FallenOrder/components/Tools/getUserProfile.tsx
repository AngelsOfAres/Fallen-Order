                    ...
                    try {
                        ...
                        if (response.status === 200) {
                            ...
                            if (main_character !== 0) {
                                ...
                                mainImage = 'https://gateway.ipfs.io/ipfs/' + charInfo.asset.params.url.substring(7)
                                ...
                                try {
                                    ...
                                    if (response.status === 200) {
                                        ...
                                        if (bgID && bgID !== '-') {
                                          ...
                                          bgImage = 'https://gateway.ipfs.io/ipfs/' + bgInfo.asset.params.url.substring(7)
                            ...
                            if (equipped_tool !== 0) {
                                ...
                                toolImage = 'https://gateway.ipfs.io/ipfs/' + toolInfo.asset.params.url.substring(7)
                            ...
                            if (listings) {
                                const listingData = listings.split('/').slice(1).map(async (listing: any) => {
                                    ...
                                    const assetImage = 'https://gateway.ipfs.io/ipfs/' + assetInfo.asset.params.url.substring(7)
