...
export default function MyBalancesTab() {
  ...
  return (
    ...
    <Center>
        ...
        :
        <>
            <HStack mb={8} textAlign='center' fontFamily='Orbitron' fontSize='12px' textColor={buttonText5} spacing='16px'>
                ...
                label={'Click To Swap $EXP'} aria-label='Tooltip'>
                    <HStack cursor='pointer' onClick={onBuyExpOpen}>
                    <Text>{expBal}</Text>
                    <Image boxSize='14px' alt='$EXP Balance' src='exp.png' />
                    </HStack>
                </Tooltip>
                ...
                label={'$ORDER'} aria-label='Tooltip'>
                    <HStack>
                    <Text>{orderBal}</Text>
                    <Image boxSize='14px' alt='$ORDER Balance' src='fallenlogo.png' />
                    </HStack>
                </Tooltip>
                ...
                label={'Oak Logs'} aria-label='Tooltip'>
                    <HStack>
                    <Text>{oakLogsBal}</Text>
                    <Image boxSize='14px' alt='$ORDER Balance' src='oaklogs.png' />
                    </HStack>
                </Tooltip>
                ...
                label={'Clay Ore'} aria-label='Tooltip'>
                    <HStack>
                    <Text>{clayOreBal}</Text>
                    <Image boxSize='14px' alt='$ORDER Balance' src='clayore.png' />
                    </HStack>
                </Tooltip>

                <Tooltip py={1} px={2} borderWidth='1px' borderRadius='lg' arrowShadowColor={buttonText5} borderColor={buttonText5}
                bgColor='black' textColor={buttonText4} fontSize='12px' fontFamily='Orbitron' textAlign='center' hasArrow
                label={'Stat $BOOST'} aria-label='Tooltip'>
                    <HStack>
                    <Text>{boostBal}</Text>
                    <Image borderRadius='4px' boxSize='14px' alt='$ORDER Balance' src='statbooster.png' />
                    </HStack>
                </Tooltip>
            </HStack>
        </>
